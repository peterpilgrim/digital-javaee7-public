...
public class WebAppRunner {
	public static void main(String args[]) throws Exception {
        System.out.println("=======================================================================");
        System.out.println("=======================================================================");
		System.out.println("Web application runner: jsf-compositions 1.0-SNAPSHOT");

        WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "demo.war")
            .addClasses(ServiceDesk.class,
                Product.class,
                ProductStatelessDataService.class,
                ProductStatefulDataService.class)
            .addAsWebInfResource(
